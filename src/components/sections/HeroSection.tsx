...
export default function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex flex-col md:flex-row items-center justify-center pt-24 pb-12 px-8 overflow-hidden z-20">
        ...
        {[...Array(20)].map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              backgroundColor: i % 2 === 0 ? '#00F5D4' : '#7B2FFF',
              top: Math.random() * 100 + '%',
      ...
      <div className="flex-1 flex flex-col items-start gap-6 max-w-2xl z-10">
        <h1 ref={textRef} className="text-5xl md:text-7xl font-display font-bold leading-[1.1] tracking-tight">
        ...
        <motion.p
          ...
          className="text-lg md:text-2xl text-softwhite/80 tracking-wide max-w-lg leading-relaxed"
        >
          Unifying <strong className="text-teal font-semibold">Precision Therapeutics</strong> and <strong className="text-electric font-semibold">Next-Gen Digital Solutions</strong>. <br/>
        ...
        >
          <Link href="/pharma" className="group relative px-8 py-4 bg-transparent border border-teal text-teal rounded-full overflow-hidden hover:text-navy transition-colors duration-300">
          ...
          <Link href="/tech" className="group relative px-8 py-4 bg-transparent border border-electric text-electric rounded-full overflow-hidden hover:text-white transition-colors duration-300">
